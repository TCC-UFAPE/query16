# Query11 - Análise Completa de Vulnerabilidades do django

## Descrição

A **Query11** é um script Python que combina as funcionalidades das queries 7 e 10 para realizar uma análise abrangente das vulnerabilidades do projeto **django**, integrando dados de documentação com informações detalhadas dos commits do GitHub.
...
| Coluna | Descrição |
|--------|-----------|
| Projeto | Nome do projeto (django) |
...
2. **Filtra vulnerabilidades** do django
...
- ✅ **Análise focada** no projeto django
